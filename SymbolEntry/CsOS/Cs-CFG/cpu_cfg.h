...
*
*           (2) If CPU_CFG_KA_IPL_BOUNDARY is set to '0', then the ARMv7-M port will use PRIMASK to
*               disable interrupts. This blocks all interrupts from execution during critical sections.
*
*           (3) If CPU_CFG_KA_IPL_BOUNDARY is greater than '0' then the ARMv7-M port will use BASEPRI to
*               disable interrupts. This allows the port to separate kernel-aware from non kernel-aware
*               ISRs. If you enable this feature, you must set your external interrupt priorities
*               accordingly. Non kernel-aware interrupts may execute during critical sections, but 
*               MUST NOT make any kernel calls.
*
*               For example, if CPU_CFG_KA_IPL_BOUNDARY is set to 4 then external interrupt priorities
*               4-15 will be kernel-aware while priorities 0-3 will be non-kernel aware.
*********************************************************************************************************
*/
