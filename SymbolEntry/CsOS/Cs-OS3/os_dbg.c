...
CPU_INT08U  const  OSDbg_CalledFromTMRChkEn    = OS_CFG_CALLED_FROM_TMR_CHK_EN;

CPU_INT08U  const  OSDbg_DynTickEn             = OS_CFG_DYN_TICK_EN;

CPU_INT08U  const  OSDbg_DataQEn               = OS_CFG_DATA_EN;
OS_DATA     const  OSDbg_DataQ                 = { 0u };
#if (OS_CFG_DATA_EN > 0u)
CPU_INT08U  const  OSDbg_DataQDelEn            = OS_CFG_DATA_DEL_EN;
CPU_INT08U  const  OSDbg_DataQFlushEn          = OS_CFG_DATA_FLUSH_EN;
CPU_INT08U  const  OSDbg_DataQPendAbortEn      = OS_CFG_DATA_PEND_ABORT_EN;
CPU_INT16U  const  OSDbg_DataQSize             = sizeof(OS_DATA);               /* Size in Bytes of OS_DATA            */
#else
CPU_INT08U  const  OSDbg_DataQDelEn            = 0u;
CPU_INT08U  const  OSDbg_DataQFlushEn          = 0u;
CPU_INT08U  const  OSDbg_DataQPendAbortEn      = 0u;
CPU_INT16U  const  OSDbg_DataQSize             = 0u;
#endif
...
CPU_INT08U  const  OSDbg_InvalidOSCallsChkEn   = OS_CFG_INVALID_OS_CALLS_CHK_EN;
...
CPU_INT08U  const  OSDbg_SchedLockTimeMeasEn   = OS_CFG_SCHED_LOCK_TIME_MEAS_EN;
...
CPU_INT08U  const  OSDbg_TickEn                = OS_CFG_TICK_EN;
...
CPU_INT08U  const  OSDbg_TSEn                  = OS_CFG_TS_EN;
...
************************************************************************************************************************
*                                                      DEBUG DATA
*                                      TOTAL DATA SPACE (i.e. RAM) USED BY Cs/OS3
************************************************************************************************************************
*/
...
void  OS_Dbg_Init (void)
{
    ...
    p_temp08 = (CPU_INT08U const *)&OSDbg_CalledFromTMRChkEn;

    p_temp08 = (CPU_INT08U const *)&OSDbg_DynTickEn;

    p_temp16 = (CPU_INT16U const *)&OSDbg_DataQ;
    p_temp08 = (CPU_INT08U const *)&OSDbg_DataQEn;
#if (OS_CFG_FLAG_EN > 0u)
    p_temp08 = (CPU_INT08U const *)&OSDbg_DataQDelEn;
    p_temp08 = (CPU_INT08U const *)&OSDbg_DataQFlushEn;
    p_temp08 = (CPU_INT08U const *)&OSDbg_DataQPendAbortEn;
    p_temp16 = (CPU_INT16U const *)&OSDbg_DataQSize;
#endif
    ...
    p_temp08 = (CPU_INT08U const *)&OSDbg_InvalidOSCallsChkEn;
    ...
    p_temp08 = (CPU_INT08U const *)&OSDbg_SchedLockTimeMeasEn;
    ...
    p_temp08 = (CPU_INT08U const *)&OSDbg_TickEn;
    ...
    p_temp08 = (CPU_INT08U const *)&OSDbg_TSEn;
