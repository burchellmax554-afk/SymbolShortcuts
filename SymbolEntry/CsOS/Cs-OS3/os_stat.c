...
*                                                    STATISTICS TASK
*
* Description: This task is internal to Cs/OS3 and is used to compute some statistics about the multitasking
...
*
*              4) This function is INTERNAL to Cs/OS3 and your application should not call it.
************************************************************************************************************************
*/
