...
*
* Description: This function is called by Cs/OS3 to initialize the list of ready priorities.
*
* Arguments  : none
*
* Returns    : none
*
* Note       : This function is INTERNAL to Cs/OS3 and your application should not call it.
************************************************************************************************************************
*/
...
*
* Description: This function is called by other Cs/OS3 services to determine the highest priority task
