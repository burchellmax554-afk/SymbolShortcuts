...
* Version : V3.09.02
*********************************************************************************************************
* Note(s) : (1) The header file os_trace_events.h is the interface between Cs/OS3 and your
*               trace recorder of choice. A supported trace tool will provide this file for you.
*********************************************************************************************************
*/
...
/*
*********************************************************************************************************
*                                 Cs/OS3 Trace Default Macros (Empty)
*********************************************************************************************************
*/
...
#ifndef  OS_TRACE_DATA_CREATE
#define  OS_TRACE_DATA_CREATE(p_data, p_name)
#endif

#ifndef  OS_TRACE_DATA_DEL
#define  OS_TRACE_DATA_DEL(p_data)
#endif

#ifndef  OS_TRACE_DATA_POST
#define  OS_TRACE_DATA_POST(p_data)
#endif

#ifndef  OS_TRACE_DATA_POST_FAILED
#define  OS_TRACE_DATA_POST_FAILED(p_data)
#endif

#ifndef  OS_TRACE_DATA_PEND
#define  OS_TRACE_DATA_PEND(p_data)
#endif

#ifndef  OS_TRACE_DATA_PEND_FAILED
#define  OS_TRACE_DATA_PEND_FAILED(p_data)
#endif

#ifndef  OS_TRACE_DATA_PEND_BLOCK
#define  OS_TRACE_DATA_PEND_BLOCK(p_data)
#endif

#ifndef  OS_TRACE_DATA_DEL_ENTER
#define  OS_TRACE_DATA_DEL_ENTER(p_data, opt)
#endif

#ifndef  OS_TRACE_DATA_POST_ENTER
#define  OS_TRACE_DATA_POST_ENTER(p_data, p_void, msg_size, opt)
#endif

#ifndef  OS_TRACE_DATA_PEND_ENTER
#define  OS_TRACE_DATA_PEND_ENTER(p_data, timeout, opt, p_msg_size, p_ts)
#endif

#ifndef  OS_TRACE_DATA_DEL_EXIT
#define  OS_TRACE_DATA_DEL_EXIT(RetVal)
#endif

#ifndef  OS_TRACE_DATA_POST_EXIT
#define  OS_TRACE_DATA_POST_EXIT(RetVal)
#endif

#ifndef  OS_TRACE_DATA_PEND_EXIT
#define  OS_TRACE_DATA_PEND_EXIT(RetVal)
#endif
