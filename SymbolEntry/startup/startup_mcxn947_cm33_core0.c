...
#endif
#endif
#include "MCUType.h" //Added for WWU type conventions. TDM
...
//*****************************************************************************
// Private function prototypes missing from NXP version. TDM
//*****************************************************************************
...
void ResetISR(void) {
    (void)__bss_section_table;  //This does not appear to be used so explicitly say so.TDM
